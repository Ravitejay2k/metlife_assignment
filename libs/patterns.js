(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    ////////////////////////
    // Form Droplist
    $('.ml-form-field-droplist button').click(function(e) {
        $(this).next('.ml-form-field-droplist-fields').toggleClass('active');
        e.preventDefault();
    });
    //Prevent default on tooltip link
    $('.ml-form-field-helptext-link').click(function(e) {
        $(this).parent().toggleClass('open');
        e.preventDefault();
    });
    //Toggle visibility 
    $('.ml-form-field-togglevisible').click(function(e) {
        $(this).toggleClass('hidden');
        var field = $(this).parent().find('input');
        
        if (field.hasClass('ml-mask-social')) {
    ...
    $('.ml-mask-social').mask('000-00-0000');
    $('.ml-mask-phone').mask('000-000-0000');
    
    
    // Form Select
    $('.ml-form-field-select').find('select').each(function(){
        var $this = $(this), numberOfOptions = $(this).children('option').length;
        //SD
        var $label = $(this).children('option:first').text();
        
        $this.addClass('select-hidden'); 
        $this.wrap('<div class="select"></div>');
        //SD
        $this.before('<label class="select-label"><span>'+$label+'</span></label>');
